  ...
  return (
    <footer className="footer">
      <div className="footer__started">
        <p className="footer__text">Ready to get started?</p>
        <button className="btn-buy btn-buy_footer">Get started</button>
      </div>
      <div className="footer__line"></div>
      <nav className="footer__nav">
        <div className="footer__container-search">
          <label className="footer__search" action="">
        ...
        <ul className="footer__menu footer__col2">
          <li>
            <a className="footer__menu-link footer__menu-link_green" href="#">
              Services
            </a>
          </li>
          <li>
        ...
        <ul className="footer__menu footer__col3">
          <li>
            <a className="footer__menu-link footer__menu-link_green" href="#">
              About
            </a>
        ...
        <ul className="footer__menu footer__col4">
          <li>
            <a className="footer__menu-link footer__menu-link_green" href="#">
              Help
            </a>
      ...
      <div className="footer__container-policy-socials">
